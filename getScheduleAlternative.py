...
# Default output_file and input_file
output_file = "calendar.ics"
input_file = "detailed-timetable.html"
...
def main():
    ...
    with open(input_file, 'r') as f:
        timetable_soup = BeautifulSoup(f, "html.parser")
...
if __name__ == "__main__":
    if len(sys.argv) > 5:
        print("Usage: python {0} -ics [<calendar-TERM.ics>] -html [<detailed-timetable.html>]".format(sys.argv[0]))
        sys.exit(0)
    elif len(sys.argv) == 5:
